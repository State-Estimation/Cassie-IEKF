function fig = SixDofAnimationTwinVideo(varargin)
    ...
    if(CreateAVI)
        ...
        if(isempty(fileName))
            ...
            % aviobj = VideoWriter(fileName, 'fps', AVIfps, 'compression', 'Cinepak', 'quality', 100);
    ...
    avi = VideoWriter(AVIfileName,'MPEG-4');
    avi.Quality=30;
    open(avi)
